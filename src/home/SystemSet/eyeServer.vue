<template>
  <s-form ref="editServer" :model="serverForm" :rules="serverRule" label-width="120px">
    <s-form-item label="服务器类型" prop="archiveDeviceType" >
      <s-col span="20">
        <s-select v-model="serverForm.archiveDeviceType" disabled>
    ...
    <s-form-item label="服务器名称" prop="archiveDeviceName" >
      <s-col span="20">
        <s-input v-model="serverForm.archiveDeviceName" disabled></s-input>
      </s-col>
    </s-form-item>
    <s-form-item label="服务器IP地址" prop="archiveDeviceIp">
      <s-col span="20">
        <s-input v-model="serverForm.archiveDeviceIp" disabled></s-input>
      </s-col>
    </s-form-item>
    <s-form-item label="服务器端口" prop="archiveDevicePort">
      <s-col span="20">
        <s-input v-model="serverForm.archiveDevicePort" disabled></s-input>
      </s-col>
    </s-form-item>
    <s-form-item label="服务器账号名" prop="archiveDeviceAccount">
      <s-col span="20">
        <s-input v-model="serverForm.archiveDeviceAccount" disabled></s-input>
      </s-col>
    </s-form-item>
    <s-form-item label="口令" prop="archiveDevicePasswd">
      <s-col span="20">
        <s-input type="password" v-model="serverForm.archiveDevicePasswd" disabled></s-input>
      </s-col>
    </s-form-item>
    <s-form-item label="归档路径" prop="archiveDeviceDir" tip="示例：/backup/" class="path-form-item">
      <s-col span="20">
        <s-input v-model="serverForm.archiveDeviceDir" disabled></s-input>
      </s-col>
    </s-form-item>
  </s-form>
</template>
