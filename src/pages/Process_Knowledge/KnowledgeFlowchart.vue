  ...
  <div class="process_graph_main">
    <div class="process-title-line">
      <div class="process-title">
        <div class="title-info">{{`知识库${this.$route.params.serialCode}流程图`}}</div>
...
export default {
  ...
  methods: {
    ...
    getFlowData(uuid) {
      $axios.get(`/itilKnowledgeOrder/getChangeFlowChart/${uuid}`).then(({ status, data }) => {
