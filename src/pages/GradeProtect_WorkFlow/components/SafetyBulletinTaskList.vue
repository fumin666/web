 ...
 * @Description: 等级保护-等保工作流-主页面
 -->
<template>
  <section class="safety-bulletin-type-set">
    <div class="btn-box">
      <s-button icon="plus" @click="addReleaseBtn">下发工作</s-button>
...
<script>
  ...
  import addReleaseBulletin from '@/pages/GradeProtect_WorkFlow/components/dialog/AddReleaseBulletin'
  import viewReleaseBulletin from '@/pages/GradeProtect_WorkFlow/components/dialog/ViewReleaseBulletin'
  import viewTaskHistory from '@/pages/GradeProtect_WorkFlow/components/dialog/ViewTaskHistory'
