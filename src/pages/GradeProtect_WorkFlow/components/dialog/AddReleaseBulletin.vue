 ...
 * @Date: 2020-3-12
 * @LastEditors: fumin
 * @Description: 等级保护-等保工作流-工作下发
 -->
<template>
  <s-dialog v-model="dialogFlag" :title= "Object.keys(rowData).length !==0 ?'编辑':'下发工作'" width="750px" append-to-body class="release-bulletin">
    <s-scrollbar wrap-class="default-dialog-scroll">
      <s-collapse accordion class="" v-model="activeNames">
        <s-collapse-item title="工作内容" name="bulletinContent">
          <s-form :model="bulletinForm" ref="contentForm" :rules="bulletinRules" label-width="135px">
            <s-form-item label="工作类型" prop="typeUuid">
        ...
        <s-collapse-item title="工作任务" name="bulletinTask">
        ...
        <s-collapse-item title="工作处理人" name="bulletinObject">
    ...
    <template slot="footer" class="dialog-footer">
      <s-button @click="saveRelease" :disabled="flag">确定</s-button>
