...
<template>
  <section class="fileList">
      ...
      <s-table-page
        ...
        <s-table-column label="操作" width="190">
          <template slot-scope="scope">
            ...
            <i class="iconfont icon-eye" title="查看稽核结果" @click="scanResult(scope.row)"></i>
    ...
    <div v-else>
      <AccountResultDialog ref="syncResult" :syncResultList="syncResultList" @back="notResultDetail=true"></AccountResultDialog>
    </div>
    <!--新增稽核任务-->
    <s-dialog
      v-model="taskAdd"
      ...
      width="950px"
      title="新增稽核任务">
      <AccountAddDialog ref="taskAdd" :emaillist="selectedEmailList" @showEmailM="bloomMyEmail = true" @showEmail="bloomLink = true"></AccountAddDialog>
    ...
    <s-dialog
      ...
      width="950px"
      title="编辑定时任务">
      <AccountEditDialog ref="taskEdit" :defaultData="rowData" :emaillist="selectedEmailList"  @showEmailM="bloomMyEmail = true" @showEmail="bloomLink = true"></AccountEditDialog>
      <template slot="footer" class="dialog-footer">
    ...
    <s-dialog
      ...
      width="950px"
      title="查看定时任务">
      <AccountEditDialog ref="taskSee" type="see" :defaultData="rowData" :emaillist="selectedEmailList"></AccountEditDialog>
    </s-dialog>
    <!--手动增加邮件-->
    <s-dialog
      ...
      v-if="bloomMyEmail"
      title="手动添加邮件">
      <AccountEmailM ref="addMyEmail"></AccountEmailM>
      <template slot="footer" class="dialog-footer">
    ...
    <s-dialog
      ...
      <s-scrollbar wrap-style="max-height: 600px;">
        <AccountEmail ref="linkEmail" :data="selectedEmailList"></AccountEmail>
      </s-scrollbar>
      <template slot="footer" class="dialog-footer">
...
<script>
  ...
  import AccountAddDialog from './AccountAuditDialog/AccountAdd.vue'
  import AccountEditDialog from './AccountAuditDialog/AccountEdit.vue'
  import AccountResultDialog from './AccountAuditDialog/AccountResult.vue'
  import AccountEmailM from './AccountAuditDialog/AccountEmailM'
  import AccountEmail from './AccountAuditDialog/AccountEmail'

  export default {
    data() {
      return {
        notResultDetail: true, // 当点击查看稽核结果时隐藏当前页面显示稽核结果页面
        taskAdd: false,
        editDialog: false,
        seeDialog: false,
        bloomMyEmail: false,
