...
<template>
  <section class="content" style="margin-top: 20px;">
    ...
    <s-table-page :data="topLists">
      <s-table-column label="日志源" prop="itcompName"></s-table-column>
      <s-table-column label="日志源IP" prop="controlAdderss"></s-table-column>
      <s-table-column label="日志源类别" prop="citypeName"></s-table-column>
      <s-table-column label="总数" prop="totol"></s-table-column>
      <s-table-column label="未知" prop="level8"></s-table-column>
      <s-table-column label="诊断" prop="level7"></s-table-column>
      <s-table-column label="信息" prop="level6"></s-table-column>
      <s-table-column label="提示" prop="level5"></s-table-column>
      <s-table-column label="警告" prop="level4"></s-table-column>
      <s-table-column label="错误" prop="level3"></s-table-column>
      <s-table-column label="致命" prop="level2"></s-table-column>
      <s-table-column label="警报" prop="level1"></s-table-column>
      <s-table-column label="应急" prop="level0"></s-table-column>
    </s-table-page>
  </section>
</template>
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        $axios.post('/syslogReport/logReportCount', period).then((res) => {
      ...
      downloadHandle(type) {
        ...
        $axios.post('/syslogReport/logReportExport', form).then((res) => {
