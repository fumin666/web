<template>
    <div>
        ...
        <div>
          <s-row>
            <s-col span='6' style="opacity:0.65">提交人：{{viewData.userName}}</s-col>
            <s-col span='10' style="opacity:0.65">提交时间：{{viewData.createTime}}</s-col>
            <s-col v-if="viewData.workType === 3" span='8' style="opacity:0.65">审批意见：{{viewData.approvalStatus === 1 ? '通过' : '拒绝'}}</s-col>
          </s-row>
        </div>
