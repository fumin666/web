  ...
  <div class="process_graph_main">
    <div class="process-title-line">
      <div class="process-title">
        <div class="title-info">{{`发布单${this.$route.params.serialCode}流程图`}}</div>
        ...
        <div class="s-steps is-horizontal" id="graphTableTitle">
          <div class="s-step otherType" id="step_11">
            <div class="s-step-main">
              <div class="s-step-title">启动</div>
            </div>
          </div>
          <div class="s-step otherType" id="step_12">
            <div class="s-step-main">
              <div class="s-step-title">计划</div>
            </div>
          </div>
          <div class="s-step otherType" id="step_13">
            <div class="s-step-main">
              <div class="s-step-title">开发</div>
            </div>
          </div>
          <div class="s-step otherType" id="step_14">
            <div class="s-step-main">
              <div class="s-step-title">测试</div>
            </div>
          </div>
          <div class="s-step otherType" id="step_15">
            <div class="s-step-main">
              <div class="s-step-title">部署</div>
            </div>
          </div>
          <div class="s-step otherType" id="step_16">
            <div class="s-step-main">
              <div class="s-step-title">关闭</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="parent" id="main-parent">
      ...
      <div class="g-graph-content">
        <div class="line">
          ...
          <div class="g-cell" id="cell15">
            <div class="r-line"></div>
          </div>
          <div class="g-cell" id="cell16"></div>
        </div>
        <div class="line">
          ...
          <div class="g-cell" id="cell25">
            <div class="r-line"></div>
          </div>
          <div class="g-cell" id="cell26"></div>
        </div>
        <div class="line">
          ...
          <div class="g-cell" id="cell35">
            <div class="r-line"></div>
          </div>
          <div class="g-cell" id="cell36"></div>
        </div>
        <div class="line">
          ...
          <div class="g-cell" id="cell45">
            <div class="r-line"></div>
          </div>
          <div class="g-cell" id="cell46"></div>
        </div>
        <div class="line">
          <div class="g-cell" id="cell51">
            <div class="r-line"></div>
          </div>
          <div class="g-cell" id="cell52">
            <div class="r-line"></div>
          </div>
          <div class="g-cell" id="cell53">
            <div class="r-line"></div>
          </div>
          <div class="g-cell" id="cell54">
            <div class="r-line"></div>
          </div>
          <div class="g-cell" id="cell55">
            <div class="r-line"></div>
          </div>
          <div class="g-cell" id="cell56"></div>
        </div>
      </div>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getFlowData(uuid) {
        $axios.get(`/itilPublishOrder/getPublishFlowChart/${uuid}`).then(({ status, data }) => {
