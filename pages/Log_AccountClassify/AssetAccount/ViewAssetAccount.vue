    ...
    <s-scrollbar wrap-style="max-height: 450px;">
      ...
      <div style="text-align: center">
        <s-row>
          ...
          <s-col span="8">
            <div class="grid-content bg-purple-light">{{viewAssetObj.assetAccountName}}</div>
          </s-col>
          <s-col span="4">
            <div class="grid-content bg-purple">资产名称</div>
          </s-col>
          <s-col span="8">
            <s-tooltip :content="viewAssetObj.assetName">
              <div class="grid-content bg-purple-light">{{viewAssetObj.assetName}}</div>
            </s-tooltip>
          </s-col>
        </s-row>
        <s-row>
          ...
          <s-col span="8">
            <div class="grid-content bg-purple-light">{{viewAssetObj.assetAccountRole}}</div>
          </s-col>
          <s-col span="4">
            <div class="grid-content bg-purple">账号状态</div>
          </s-col>
          <s-col span="8">
            <div class="grid-content bg-purple-light">{{viewAssetObj.assetAccountStatus}}</div>
          </s-col>
        </s-row>
        <s-row>
          <s-col span="4">
          ...
          <s-col span="8">
            <div class="grid-content bg-purple-light">{{viewAssetObj.assetAccountClassify}}</div>
          </s-col>
          <s-col span="4">
