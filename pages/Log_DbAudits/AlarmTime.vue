  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        $axios.post('/dbauditReport/alarmAudit', form).then((res) => {
          // this.dataChart.data = res.data
      ...
      downloadHandle(type) {
        let form = this.formData()
          Download(`/dbauditReport/alarmAuditExport/${form.startTime}/${form.endTime}/${form.timeType}/${type}`);
      }
    },
    mounted() {
      this.getList()
