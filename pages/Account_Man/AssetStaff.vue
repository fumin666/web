<template>
  <s-row type="flex" :gutter="20" class="people-manage-box" style="height: calc(100vh - 250px);">
    ...
    <s-dialog
      ...
      width="700px"
      title="批量编辑">
      <edit-batch ref="editBatchForm"></edit-batch>
      <template slot="footer" class="dialog-footer">
...
<script type="text/babel">
  ...
  import PermissionDialog from '@/pages/Account_Organization/AccountPermission';
  ...
  import CreateAccount from '@/pages/Account_SecuritySet/CreateAccountConfig.vue'
  import {cloneDeep} from 'lodash'
  import {Download, base64, Validaters} from 'sunflower-common-utils'
        ...
        return [
          ...
          },
          {
            ...
            v_if: function (row, scope) {
              return row.uuid !== 'cu2704bbea9847d1b745e9e5d33d8732'
            }
          },
          {
            icon: 'magnifier',
