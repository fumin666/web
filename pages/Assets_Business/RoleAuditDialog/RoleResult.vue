...
<template>
  <section class="fileList">
    ...
    <s-dialog v-model="syncResultDialog" v-if="syncResultDialog" width="950px" title="查看稽核结果详情">
      <RoleResultDetailDialog ref="resultDetail" :syncResultList="syncResultList"></RoleResultDetailDialog>
    </s-dialog>
...
<script>
  ...
  import RoleResultDetailDialog from './RoleResultDetail.vue'
