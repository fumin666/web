...
<template>
  <section class="fileList">
    ...
    <s-dialog v-model="syncResultDialog" v-if="syncResultDialog" width="900px" title="查看同步结果详情">
      <BusinessResultDetailDialog ref="resultDetail" :syncResultList="syncResultList"></BusinessResultDetailDialog>
    </s-dialog>
...
<script>
  ...
  import BusinessResultDetailDialog from './BusinessResultDetail.vue'
