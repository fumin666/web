  ...
  <div class="process_graph_main">
    <div class="process-title-line">
      <div class="process-title">
        <div class="title-info">{{`变更单${this.$route.params.serialCode}流程图`}}</div>
      ...
      <div class="g-graph-content">
        <div class="s-steps is-horizontal" id="graphTableTitle">
          ...
          <div class="s-step otherType" id="step_12">
            <div class="s-step-main">
              <div class="s-step-title">符合与确认</div>
            </div>
          </div>
          <div class="s-step otherType" id="step_13">
            <div class="s-step-main">
              <div class="s-step-title">计划与安排</div>
            </div>
          </div>
          <div class="s-step otherType" id="step_14">
            <div class="s-step-main">
              <div class="s-step-title">执行</div>
            </div>
          </div>
    ...
    <div class="parent" id="main-parent">
      ...
      <div class="g-graph-content">
        ...
        <div class="line">
          ...
          <div class="g-cell" id="cell55"></div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    getFlowData(uuid) {
      $axios.get(`/itilChangeOrder/getChangeFlowChart/${uuid}`).then(({ status, data }) => {
