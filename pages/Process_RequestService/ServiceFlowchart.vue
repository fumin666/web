  ...
  <div class="process_graph_main">
    <div class="process-title-line">
      <div class="process-title">
        <div class="title-info">{{`服务请求单${this.$route.params.serialCode}流程图`}}</div>
...
export default {
  ...
  methods: {
    ...
    getFlowData(uuid) {
      $axios.get(`/itilServiceRequest/getRequestFlowChart/${uuid}`).then(({ status, data }) => {
